  ...
  <body>
    ...
    <nav
      ...
      <div
        ...
        <div
          ...
          <a
                        class="navbar-brand"
                        href="index.html">{$data/project/abbr/text()}<span
                            class="hidden-xs">: {$title}</span></a>
        </div>
      </div>
    </nav>
    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <div
                        class="col-md-3">
                    <img
                            src="{$data/project/image/url/text()}"
                            alt="{$data/project/image/description/text()}"/>
                    <p
                            class="mpese-home-img-caption">{$data/project/image/description/text()}<br/>
      ...
      <div
          ...
          <img
                        class="logo"
                        src="resources/img/logo-AHRC.jpg"
                        height="50"
                        alt="AHRC"/>
          <img
                        class="logo"
                        src="resources/img/logo-birmingham.svg"
                        height="50"
                        alt="University of Birmingham"/>
          <img
                        class="logo"
                        src="resources/img/logo-bristol.svg"
                        height="50"
